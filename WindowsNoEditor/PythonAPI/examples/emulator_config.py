...
CARLA_SERIAL_PORT = 'COM2'  # local emulated serial port
...
EXTERNAL_ID = 0  # define the Receiver ID to be the final string of digits in the receiving machine’s IP address
