...
EMULATED_CONFIG_FILE = "control/emulated_config.txt"
...
USE_CARLA_DATA = False  # True-->Connects to Carla simulation, False-->Connects to Vehicle's radio
MAX_SPEED = -1
CARLA_SERIAL_PORT = -1
